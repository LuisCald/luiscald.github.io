...
<style>
  ...
  a:hover {
    color: #005a99; /* Change link color on hover */
  }
...
<ul>
  <li>
    ...
    <span>(Joint work with Christian Bayer and Moritz Kuhn) --- submitted</span>
  ...
  <li>
    <strong><a href="/pdfs/Conley_nonlinear.pdf" target="_blank" rel="noopener noreferrer">Spatial standard errors for several commonly used M-estimators</a></strong>
    <span>(Joint work with Leander Heldring) --- R&R at the International Journal for Computational Economics and Econometrics</span>
  ...
  <li>
    <strong><a href="project1.pdf">The Role of the Distribution for Monetary Policy</a></strong>
    <p>Draft coming soon!</p>
  </li>
  <li>
    <strong><a href="project1.pdf">The Distributional Effects of Systematic Monetary Policy</a></strong>
    <p>Work in progress</p>
  </li>
  <li>
    <strong><a href="project1.pdf">Unequal Barrels and Slick Consequences: The Distributional Impact of Oil Shocks</a></strong>
    <span>(Joint work with Theo Drossidis)</span>
    <p>Work in progress</p>
  </li>
</ul>
