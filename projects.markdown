...
<ul class="research-list">
  <li>
    ...
    <div class="paper-links">
      <a class="paper-link" href="/distributional-dynamics/" target="_blank" rel="noopener noreferrer">Website</a>
      <a class="paper-link" href="/pdfs/BCK_DD.pdf" target="_blank" rel="noopener noreferrer">Paper</a>
      <a class="paper-link" href="https://github.com/LuisCald/DD_replication" target="_blank" rel="noopener noreferrer">Replication code</a>
      <a class="paper-link" href="https://github.com/LuisCald/DD_data" target="_blank" rel="noopener noreferrer">Download data</a>
    </div>
  ...
  <li>
    <a class="paper-title" href="/pdfs/Calderon_OilMonetaryPolicy.pdf" target="_blank" rel="noopener noreferrer">Oil Supply Shocks and Monetary Policy</a>
    <div class="meta">Authors: Luis Calderon</div>
    <div class="meta">Status: Preliminary draft (June 2026)</div>
  ...
  <li>
    <span class="paper-title">Distributional Counterfactuals</span>
    <div class="meta">Authors: Luis Calderon</div>
    <div class="meta">Status: Working paper — draft coming soon</div>
    <p>Using the sufficient-statistics counterfactual framework of Caravello, McKay and Wolf (2024), I study how changes in the systematic conduct of monetary policy affect both macroeconomic aggregates and the joint distribution of U.S. household consumption, income, and wealth.</p>
  </li>
  <li>
